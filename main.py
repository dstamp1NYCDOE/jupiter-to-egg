...
def main(data):
    ...
    # convert percentages
    assignments_df['Percent%'] = assignments_df.apply(
        convert_percentages, axis=1)
    ...
    assignments_df['numerator'] = assignments_df['WorthPoints'] * \
        assignments_df['Percent%']
    ...
    student_grades_df['Category%'] = student_grades_df['numerator'] / \
        student_grades_df['denominator']
    student_grades_df['weighted%'] = student_grades_df['Category%'] * \
        student_grades_df['CategoryWeight']

    student_grades_df = student_grades_df.groupby(['StudentID', 'Course', 'Section'])[
